...
export const metadata: Metadata = {
	...
	description:
		"A customizable seasonal activity calendar for families everywhere.",
};
					...
					<nav className="flex items-center gap-3 text-sm font-medium">
						{user ? (
							<>
								<Link
									href="/dashboard"
									className="rounded-full bg-white/70 px-4 py-2 shadow-sm hover:bg-white"
								>
									Dashboard
								</Link>
								<Link
							...
							<Link
								href="/login"
								className="rounded-full bg-ink px-4 py-2 text-white shadow-sm hover:bg-black"
							>
								Sign in
							</Link>
						)}
